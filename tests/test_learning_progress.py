        ...
        for level, lessons in lesson_sets.items():
            for i, lesson in enumerate(lessons):
                ...
                for j, s in enumerate(steps):
                    ...
                    self.assertIn(s["type"], ("concept", "practice", "review", "debug", "fill", "example", "muscle", "memory"),
                    ...
                    if s["type"] == "practice":
                        ...
                        for field in ("instruction", "code"):
                            self.assertIn(field, s,
                                f"Memory step {j} in '{lesson['title']}' missing '{field}'")
