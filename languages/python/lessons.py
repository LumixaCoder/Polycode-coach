"""Python lessons - canonical source for Python track.

This is the single source of truth for the 36 Python lessons.
lesson_data.py re-exports from here for backward compatibility.
Edit lessons here; learn_python_gui.py will dynamic-import this module
at runtime (via languages.python.lessons) and fall back to its embedded
copy only if this file is missing.
"""
